    ...
    <div className="min-h-screen bg-gray-50 p-8 font-sans">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8 border-b border-gray-200 pb-6">
            ...
            <button onClick={handleSubmit} disabled={loading} className="bg-blue-600 text-white px-8 py-3 rounded-full font-bold shadow-lg hover:bg-blue-700 transition active:scale-95">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div className="mt-4 flex items-center gap-2">
                        <input type="checkbox" id="onSale" className="w-5 h-5 accent-blue-600" 
                            checked={formData.onSale} onChange={e => setFormData({...formData, onSale: e.target.checked})} 
                        />
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" className="w-full p-3 border border-gray-300 rounded-lg text-gray-700 outline-none" 
                                value={formData.shippingWeight} onChange={e => setFormData({...formData, shippingWeight: e.target.value})} 
                            />
                        </div>
                    </div>
                    <div className="mt-4">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <div className="space-y-2 max-h-64 overflow-y-auto pr-2">
                        {dbCategories.length > 0 ? (
                            ...
                            <p className="text-sm text-gray-400 italic py-2">No categories found in database.</p>
                        )}
                    </div>
                </div>
            </div>
